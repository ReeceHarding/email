...
drop type if exists outreach_status_type;
drop table if exists public.business_profiles;

-- Create enum type for outreach_status
create type outreach_status_type as enum ('pending', 'contacted', 'responded', 'converted', 'rejected');
...
create table public.business_profiles (
  ...
  outreach_status outreach_status_type not null default 'pending',
